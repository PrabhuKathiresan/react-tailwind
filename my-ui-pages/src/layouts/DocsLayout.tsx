...
export default function DocsLayout() {
  return (
    <div>
      ...
      <div className="flex">
        <aside className="w-full max-w-[240px] h-[calc(100dvh-61px)] overflow-y-auto border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 sticky top-[60px] hidden md:block">
          <NavList />
        </aside>
